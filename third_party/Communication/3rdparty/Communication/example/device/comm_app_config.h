...
/* ========== IMU 角度映射（下位机输出的 yaw/pitch/roll） ========== */
/* 角度源为 INS_angle: [0]=yaw, [1]=pitch, [2]=roll (rad). */
#ifndef COMM_IMU_YAW_IDX
#define COMM_IMU_YAW_IDX 0
#endif
#ifndef COMM_IMU_YAW_SIGN
#define COMM_IMU_YAW_SIGN 1
#endif

#ifndef COMM_IMU_PITCH_IDX
#define COMM_IMU_PITCH_IDX 1
#endif
#ifndef COMM_IMU_PITCH_SIGN
#define COMM_IMU_PITCH_SIGN 1
#endif

#ifndef COMM_IMU_ROLL_IDX
#define COMM_IMU_ROLL_IDX 2
#endif
#ifndef COMM_IMU_ROLL_SIGN
#define COMM_IMU_ROLL_SIGN 1
#endif
