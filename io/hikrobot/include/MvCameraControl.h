 ...
 *  @return ?????????MV_OK??????????????
 *  @remarks Windows????????OpenGL??????????PixelType_Gvsp_RGB8_Packed??PixelType_Gvsp_BGR8_Packed??PixelType_Gvsp_Mono8??????????????С????4GB??????????Linux??????????????????????
             ??????Сδ????4GB????????С??int????
 ...
 *  @remarks ????????????????????????????????????????????????????????
             ...
             UpcomingImage:????????????????????????б???????????????豸??????????????
			 ?ò??????MV_GIGE_DEVICE??MV_USB_DEVICE?豸?????MV_USB_DEVICE?豸????? MV_GrabStrategy_UpcomingImage ????
			 ???ò?????????MV_CAMERALINK_DEVICE??MV_1394_DEVICE??GenTL??????豸??
...
/********************************************************************//**
 *  @~chinese
 *  @brief  ????????????????????????windows?????????MV_GrabStrategy_LatestImages?????????Ч????Χ??1-ImageNodeNum??
 *  @param  handle                      [IN]            ?豸???
...
*  @~chinese
*  @brief   ???????
*  @param   nTLayerType        [IN]             ???????????? eg: (MV_GIGE_INTERFACE | MV_CAMERALINK_INTERFACE | MV_CXP_INTERFACE| MV_XOF_INTERFACE??
 ...
 *  @brief  ????GVSP?????????
 *  @param  handle                      [IN]            ?豸???
 *  @param  nMillisec                   [IN]            ?????????30ms????Χ:[10 - UINT_MAX)
 *  @return ?????????MV_OK?????????????? 
...
*  @remarks ??????? MV_CC_GetPayloadSize ????????С??????? MV_CC_AllocAlignedBuffer ????????????MV_CC_RegisterBuffer???
            start?????,??????3????????????????3?????SDK?У? ??U??/???????????ò??????????????????????MV_CC_GetValidImageNum С??????????????????
