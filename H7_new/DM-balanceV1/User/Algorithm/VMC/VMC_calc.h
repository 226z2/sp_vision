...
extern uint8_t ground_detectionR(vmc_leg_t *vmc,INS_t *ins, fp32 ground_detection);//右腿离地检测
extern uint8_t ground_detectionL(vmc_leg_t *vmc,INS_t *ins, fp32 ground_detection);//左腿离地检测
