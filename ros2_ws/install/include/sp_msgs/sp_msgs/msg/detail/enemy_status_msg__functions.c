...
sp_msgs__msg__EnemyStatusMsg__init(sp_msgs__msg__EnemyStatusMsg * msg)
{
  ...
  // enemy_team
  // detected_enemy_ids
  if (!rosidl_runtime_c__int8__Sequence__init(&msg->detected_enemy_ids, 0)) {
    sp_msgs__msg__EnemyStatusMsg__fini(msg);
    return false;
  }
  return true;
...
sp_msgs__msg__EnemyStatusMsg__fini(sp_msgs__msg__EnemyStatusMsg * msg)
{
  ...
  // enemy_team
  // detected_enemy_ids
  rosidl_runtime_c__int8__Sequence__fini(&msg->detected_enemy_ids);
}
...
sp_msgs__msg__EnemyStatusMsg__are_equal(const sp_msgs__msg__EnemyStatusMsg * lhs, const sp_msgs__msg__EnemyStatusMsg * rhs)
{
  ...
  // fire_allowed
  if (lhs->fire_allowed != rhs->fire_allowed) {
    return false;
  }
  // enemy_team
  if (lhs->enemy_team != rhs->enemy_team) {
    return false;
  }
  // detected_enemy_ids
  if (!rosidl_runtime_c__int8__Sequence__are_equal(
      &(lhs->detected_enemy_ids), &(rhs->detected_enemy_ids)))
  {
    return false;
  }
  return true;
  ...
  sp_msgs__msg__EnemyStatusMsg * output)
{
  ...
  // fire_allowed
  output->fire_allowed = input->fire_allowed;
  // enemy_team
  output->enemy_team = input->enemy_team;
  // detected_enemy_ids
  if (!rosidl_runtime_c__int8__Sequence__copy(
      &(input->detected_enemy_ids), &(output->detected_enemy_ids)))
  {
    return false;
  }
  return true;
...
sp_msgs__msg__EnemyStatusMsg__create(void)
{
