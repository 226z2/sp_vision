  ...
  std::ostream & out)
{
  ...
  {
    out << "fire_allowed: ";
    rosidl_generator_traits::value_to_yaml(msg.fire_allowed, out);
    out << ", ";
  }
  ...
  {
    out << "enemy_team: ";
    rosidl_generator_traits::value_to_yaml(msg.enemy_team, out);
    out << ", ";
  }

  // member: detected_enemy_ids
  {
    if (msg.detected_enemy_ids.size() == 0) {
      out << "detected_enemy_ids: []";
    } else {
      out << "detected_enemy_ids: [";
      size_t pending_items = msg.detected_enemy_ids.size();
      for (auto item : msg.detected_enemy_ids) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
