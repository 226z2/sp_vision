...
bool sp_msgs__msg__autoaim_target_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // main_target_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "main_target_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->main_target_id = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // has_target
...
PyObject * sp_msgs__msg__autoaim_target_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {  // main_target_id
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->main_target_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "main_target_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
